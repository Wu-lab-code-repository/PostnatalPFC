...
sampleraw=os.listdir('/home/gpfs/home/wulab15/HumanPFC/snRNA/embryo/raw/')
sampleraw
...
for i in range(0,len(sampleraw)):
    ...
    os.chdir('/home/gpfs/home/wulab15/HumanPFC/snRNA/embryo/raw/')
...
sampleraw=os.listdir('/home/gpfs/home/wulab15/HumanPFC/snRNA/postnatal/raw/')
sampleraw
...
for i in range(0,len(sampleraw)):
    ...
    print(samplename)
    print(predicted_doublets[predicted_doublets==False].shape)        
    os.chdir('/home/gpfs/home/wulab15/HumanPFC/snRNA/postnatal/raw/')
    np.savetxt('%s_doublet_position.csv'%(samplename), predicted_doublets, delimiter="\t")
    pd.DataFrame(doublet_scores).to_csv('%s_doublet_score_test.csv'%(samplename),sep='\t',header=0)
    pd.DataFrame(PFCi.index).to_csv('%s_doublet_score_cell_name_test.csv'%(samplename),sep='\t',header=0)
...
sampleraw=os.listdir('/home/gpfs/home/wulab15/HumanPFC/snRNA/HerringData/postnatal/raw/')
sampleraw
...
for i in range(0,len(sampleraw)):
    ...
    print(samplename)
    print(predicted_doublets[predicted_doublets==False].shape)        
    os.chdir('/home/gpfs/home/wulab15/HumanPFC/snRNA/HerringData/postnatal/raw/')
    np.savetxt('%s_doublet_position.csv'%(samplename), predicted_doublets, delimiter="\t")
    pd.DataFrame(doublet_scores).to_csv('%s_doublet_score_test.csv'%(samplename),sep='\t',header=0)
    pd.DataFrame(PFCi.index).to_csv('%s_doublet_score_cell_name_test.csv'%(samplename),sep='\t',header=0)
...
sampleraw=os.listdir('/home/gpfs/home/wulab15/HumanPFC/snRNA/HerringData/embryo/raw/')
sampleraw
...
for i in range(0,len(sampleraw)):
    ...
    print(samplename)
    print(predicted_doublets[predicted_doublets==False].shape)        
    os.chdir('/home/gpfs/home/wulab15/HumanPFC/snRNA/HerringData/embryo/raw/')
    np.savetxt('%s_doublet_position.csv'%(samplename), predicted_doublets, delimiter="\t")
    pd.DataFrame(doublet_scores).to_csv('%s_doublet_score_test.csv'%(samplename),sep='\t',header=0)
    pd.DataFrame(PFCi.index).to_csv('%s_doublet_score_cell_name_test.csv'%(samplename),sep='\t',header=0)
